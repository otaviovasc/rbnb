...
Accommodation.create!(title: "Flat in Pluto", address: "Pluto's ave, 1", category: "Gas made flat", price: 12.5, user: araceli, description: "Very nice place home in Pluto")
